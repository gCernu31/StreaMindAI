...
function DemoSection({ user }) {
  return (
    <section
      ...
      style={{
        background: 'radial-gradient(ellipse 80% 60% at 50% 50%, rgba(88,28,235,0.14) 0%, rgba(67,56,202,0.08) 40%, transparent 70%), linear-gradient(180deg, #0d0d0d 0%, #09070f 50%, #0d0d0d 100%)',
      }}
    >
      <div className="max-w-lg mx-auto flex flex-col items-center text-center">
        ...
        <p className="text-base mb-7" style={{ color: '#a0a0a0' }}>
          Piano Free attivo subito. Nessuna carta di credito richiesta.
        </p>
        <Link
          ...
          style={{ backgroundColor: '#8B5CF6', boxShadow: '0 0 28px rgba(139,92,246,0.4)' }}
          onMouseEnter={e => { e.currentTarget.style.backgroundColor = '#7C3AED'; e.currentTarget.style.boxShadow = '0 0 40px rgba(139,92,246,0.55)'; }}
          onMouseLeave={e => { e.currentTarget.style.backgroundColor = '#8B5CF6'; e.currentTarget.style.boxShadow = '0 0 28px rgba(139,92,246,0.4)'; }}
        >
